 ...
 */
final class Version20220629151140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE questions ADD formulaires_id INT NOT NULL, CHANGE formulaire_id formulaire_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE questions DROP formulaires_id, CHANGE formulaire_id formulaire_id INT DEFAULT NULL');
    }
}
